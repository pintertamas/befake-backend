...
Ez a megoldás viszont előhozza azt a problémát, hogy mivel külön szerver generálja a kódot és egy másik validálja, más secretekkel is fognak dolgozni, ami miatt nem fogják csak úgy elfogadni a megadott tokeneket hanem invalidnak tekintik.
